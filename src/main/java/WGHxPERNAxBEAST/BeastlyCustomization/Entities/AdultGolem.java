...
public class AdultGolem extends IronGolemEntity{
	...
	public double health = 140.0D;
	public double move_speed = 0.5D;
	public double knock_back_resist = 1.5D;
	public ResourceLocation textureLoc = BeastlyCustomizationMain.location("textures/entity/bs_golem.png");
	
	public AdultGolem(EntityType<? extends AdultGolem> type, World worldIn) {
		super(type, worldIn);
	}
	
	public AdultGolem setAttributes(Double health, Double speed, Double kb_resist, String name) {
		this.health = health;
