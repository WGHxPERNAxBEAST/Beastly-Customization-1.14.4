...
public class DeathBoxBlockOrig extends ContainerBlock implements IWaterLoggable {
	   ...
	   private static final DeathBoxBlockOrig.InventoryFactory<IInventory> field_220109_i = new DeathBoxBlockOrig.InventoryFactory<IInventory>() {
	   ...
	   private static final DeathBoxBlockOrig.InventoryFactory<INamedContainerProvider> field_220110_j = new DeathBoxBlockOrig.InventoryFactory<INamedContainerProvider>() {
	   ...
	   public DeathBoxBlockOrig(Block.Properties properties) {
	      super(properties);
	...
	public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
	   ...
	   @Nullable
	   public static <T> T func_220106_a(BlockState p_220106_0_, IWorld p_220106_1_, BlockPos p_220106_2_, boolean allowBlocked, DeathBoxBlockOrig.InventoryFactory<T> p_220106_4_) {
