	      ...
	      if (worldIn.isRemote) {
	         return true;
	    	  ...
	    	  if (player.isCreative()) {
	    		  ...
	    		  BeastlyCustomizationMain.logger.log(Level.INFO, "\"{} == {}\" evaluates to: {}", player.getName().getString(), owner.getName().getString(), (player.getName().getString() == owner.getName().getString()));
	    		  if (owner == null) {
