...
public class BatteryContainer extends Container{
	...
	private BatteryTile tileEntity;
	...
	public BatteryContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ContainerList.battery, windowId);
        tileEntity = (BatteryTile) world.getTileEntity(pos);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, BlockList.battery);
    }
