...
public class ItemMegaTool extends ToolItem {
	...
	protected ItemMegaTool(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
	...
	public boolean canHarvestBlock(BlockState blockIn) {
		...
		return material == Material.ROCK || material == Material.IRON || material == Material.ANVIL || material == Material.SAND || material == Material.CLAY || material == Material.EARTH || material == Material.BAMBOO || material == Material.CACTUS || material == Material.GOURD || material == Material.PISTON || material == Material.SHULKER || material == Material.SNOW || material == Material.SNOW_BLOCK || material == Material.SPONGE || material == Material.TNT || material == Material.WOOD;
	}
