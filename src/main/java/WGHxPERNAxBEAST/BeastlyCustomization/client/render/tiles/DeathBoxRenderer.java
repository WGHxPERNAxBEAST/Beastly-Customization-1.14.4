...
@OnlyIn(Dist.CLIENT)
public class DeathBoxRenderer<T extends TileEntity & IChestLid> extends BcTileEntityRenderer<T> {
	   private static final ResourceLocation TEXTURE_NORMAL_DOUBLE = new ResourceLocation("textures/entity/chest/death_box_double.png");
	   private static final ResourceLocation TEXTURE_NORMAL = new ResourceLocation("textures/entity/chest/death_box.png");
	   private final ChestModel simpleChest = new ChestModel();
	   private final ChestModel largeChest = new LargeChestModel();

	   public DeathBoxRenderer() {
	   }
