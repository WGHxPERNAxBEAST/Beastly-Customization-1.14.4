...
public class BcTileEntityRenderer <T extends TileEntity> {
	   ...
	   protected BcTileEntityRendererDispatcher rendererDispatcher;
	   ...
	   public void setRendererDispatcher(BcTileEntityRendererDispatcher rendererDispatcherIn) {
