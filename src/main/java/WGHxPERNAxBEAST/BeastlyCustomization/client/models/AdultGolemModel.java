...
public class AdultGolemModel extends EntityModel<AdultGolem> {
	   ...
	   public AdultGolemModel() {
	      this(0.0F);
	   }

	   public AdultGolemModel(float p_i1161_1_) {
	      this(p_i1161_1_, -7.0F);
	   }

	   public AdultGolemModel(float p_i46362_1_, float p_i46362_2_) {
	   ...
	   public void render(AdultGolem entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
	   ...
	   public void setRotationAngles(AdultGolem entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
	   ...
	   public void setLivingAnimations(AdultGolem entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
