...
@OnlyIn(Dist.CLIENT)
public class ToolCrafterGui extends ContainerScreen<ToolCrafterContainer> {

    private ResourceLocation GUI = new ResourceLocation(BeastlyCustomizationMain.modid, "textures/gui/tool_crafter_gui.png");

    public ToolCrafterGui(ToolCrafterContainer container, PlayerInventory inv, ITextComponent name) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
    	drawCenteredString(Minecraft.getInstance().fontRenderer, "Tool Crafter", 91, 3, 0xffffff);
