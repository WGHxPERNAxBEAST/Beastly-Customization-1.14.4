	...
	public static class RegistryEvents{
		...
		public static void registerItems(final RegistryEvent.Register<Item> event) {
			event.getRegistry().registerAll (
					...
					ItemList.rds_pick = new ItemCustomPickaxe(ToolMatList.rds_mat, 2, 1.4F, new Item.Properties().group(bcItemGroup)).setRegistryName(location("rds_pick")),
					...
					ItemList.pps_axe = new ItemCustomAxe(ToolMatList.pps_mat, 11.25F, 0.75F, new Item.Properties().group(bcItemGroup)).setRegistryName(location("pps_axe")),
					...
					ItemList.pps_pick = new ItemCustomPickaxe(ToolMatList.pps_mat, 3, 0.7F, new Item.Properties().group(bcItemGroup)).setRegistryName(location("pps_pick")),
					ItemList.pps_shovel = new ShovelItem(ToolMatList.pps_mat, 3.375F, 0.75F, new Item.Properties().group(bcItemGroup)).setRegistryName(location("pps_shovel")),
